...
bin: $(Dobj)/collisions.o $(Dobj)/game.o $(Dobj)/main.o $(Dobj)/walls.o $(Dobj)/simple_draw.o $(Dobj)/tanks.o $(Dobj)/player.o
	gcc -o ./bin $(Dobj)/collisions.o $(Dobj)/game.o $(Dobj)/main.o $(Dobj)/walls.o $(Dobj)/simple_draw.o $(Dobj)/tanks.o $(Dobj)/player.o $(libs)
